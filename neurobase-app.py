def main():
    ...
    if 'autenticado' not in st.session_state:
        st.session_statedef autenticacao():
    """Interface de autenticação do sistema"""
    st.markdown("<h1 class='main-header'>NeuroBase - Sistema de Gestão em Psicomotricimport streamlit as st
import pandas as pd
import numpy as np
import datetime
import json
            ...
            if submit:
                if email and senha:
                    ...
                    if autenticado:
                        ...
                        # Não usamos st.rerun() aqui para evitar o problema
                        return True
                    else:
